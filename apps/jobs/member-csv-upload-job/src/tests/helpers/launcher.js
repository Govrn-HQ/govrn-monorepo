// Original code can be found at https://github.com/nats-io/nats.js/blob/main/test/helpers/launcher.js#L1
const path = require('path');
const http = require('http');
const { deferred, delay, timeout, nuid } = require('nats');
...
exports.NatsServer = class NatsServer {
  ...
  static async startCluster(count = 2, conf = {}, debug = false) {
    conf = conf || {};
  ...
  static async addClusterMember(ns, conf = {}, debug = false) {
