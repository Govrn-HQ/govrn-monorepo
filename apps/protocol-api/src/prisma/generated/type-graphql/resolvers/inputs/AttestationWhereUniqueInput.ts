...
export class AttestationWhereUniqueInput {
  ...
  @TypeGraphQL.Field(_type => AttestationUser_idContribution_idCompoundUniqueInput, {
    nullable: true
  })
  user_id_contribution_id?: AttestationUser_idContribution_idCompoundUniqueInput | undefined;
}
