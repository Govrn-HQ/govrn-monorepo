...
export class TwitterTweetUpdateManyWithoutTwitter_userInput {
  ...
  @TypeGraphQL.Field(
    _type => [TwitterTweetUpsertWithWhereUniqueWithoutTwitter_userInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [TwitterTweetUpdateWithWhereUniqueWithoutTwitter_userInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [TwitterTweetUpdateManyWithWhereWithoutTwitter_userInput],
    {
      nullable: true,
    },
  )
  updateMany?:
    | TwitterTweetUpdateManyWithWhereWithoutTwitter_userInput[]
    | undefined;
