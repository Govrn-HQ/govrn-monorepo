...
@TypeGraphQL.InputType(
  'CategoryActivityCreateNestedOneWithoutActivityTypesInput',
  {
    isAbstract: true,
  },
)
export class CategoryActivityCreateNestedOneWithoutActivityTypesInput {
  ...
  @TypeGraphQL.Field(
    _type => CategoryActivityCreateOrConnectWithoutActivityTypesInput,
    {
      nullable: true,
    },
  )
  connectOrCreate?:
    | CategoryActivityCreateOrConnectWithoutActivityTypesInput
    | undefined;
