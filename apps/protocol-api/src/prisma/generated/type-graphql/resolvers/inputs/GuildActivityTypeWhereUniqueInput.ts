...
export class GuildActivityTypeWhereUniqueInput {
  ...
  @TypeGraphQL.Field(
    _type => GuildActivityTypeGuild_idActivity_type_idCompoundUniqueInput,
    {
      nullable: true,
    },
  )
  guild_id_activity_type_id?:
    | GuildActivityTypeGuild_idActivity_type_idCompoundUniqueInput
    | undefined;
}
