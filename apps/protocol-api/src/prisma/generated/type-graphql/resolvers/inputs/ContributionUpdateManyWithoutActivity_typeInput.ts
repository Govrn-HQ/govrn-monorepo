...
export class ContributionUpdateManyWithoutActivity_typeInput {
  ...
  @TypeGraphQL.Field(
    _type => [ContributionCreateOrConnectWithoutActivity_typeInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [ContributionUpsertWithWhereUniqueWithoutActivity_typeInput],
    {
      nullable: true,
    },
  )
  upsert?:
    | ContributionUpsertWithWhereUniqueWithoutActivity_typeInput[]
    | undefined;

  @TypeGraphQL.Field(
    _type => ContributionCreateManyActivity_typeInputEnvelope,
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [ContributionUpdateWithWhereUniqueWithoutActivity_typeInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [ContributionUpdateManyWithWhereWithoutActivity_typeInput],
    {
      nullable: true,
    },
  )
  updateMany?:
    | ContributionUpdateManyWithWhereWithoutActivity_typeInput[]
    | undefined;
