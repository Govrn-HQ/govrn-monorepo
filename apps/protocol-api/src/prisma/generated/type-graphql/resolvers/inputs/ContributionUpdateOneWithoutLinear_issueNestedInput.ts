...
@TypeGraphQL.InputType("ContributionUpdateOneWithoutLinear_issueNestedInput", {
  isAbstract: true
})
export class ContributionUpdateOneWithoutLinear_issueNestedInput {
  ...
  @TypeGraphQL.Field(_type => ContributionCreateOrConnectWithoutLinear_issueInput, {
    nullable: true
  })
  connectOrCreate?: ContributionCreateOrConnectWithoutLinear_issueInput | undefined;
