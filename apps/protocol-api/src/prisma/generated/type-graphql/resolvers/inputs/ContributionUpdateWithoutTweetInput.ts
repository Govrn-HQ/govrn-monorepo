...
@TypeGraphQL.InputType('ContributionUpdateWithoutTweetInput', {
  isAbstract: true,
})
export class ContributionUpdateWithoutTweetInput {
  ...
  @TypeGraphQL.Field(
    _type => ContributionStatusUpdateOneRequiredWithoutContributionsInput,
    {
      nullable: true,
    },
  )
  status?:
    | ContributionStatusUpdateOneRequiredWithoutContributionsInput
    | undefined;

  @TypeGraphQL.Field(
    _type => ActivityTypeUpdateOneRequiredWithoutContributionsInput,
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => GuildContributionUpdateManyWithoutContributionInput,
    {
      nullable: true,
    },
  )
