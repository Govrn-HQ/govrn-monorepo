...
@TypeGraphQL.InputType("CategoryActivityTypeCreateManyActivity_typeInputEnvelope", {
  isAbstract: true
})
export class CategoryActivityTypeCreateManyActivity_typeInputEnvelope {
  @TypeGraphQL.Field(_type => [CategoryActivityTypeCreateManyActivity_typeInput], {
    nullable: false
  })
