...
@TypeGraphQL.InputType("GuildActivityTypeUpdateManyWithoutActivity_typeNestedInput", {
  isAbstract: true
})
export class GuildActivityTypeUpdateManyWithoutActivity_typeNestedInput {
