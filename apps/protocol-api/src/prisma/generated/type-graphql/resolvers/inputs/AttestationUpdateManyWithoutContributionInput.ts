...
export class AttestationUpdateManyWithoutContributionInput {
  ...
  @TypeGraphQL.Field(
    _type => [AttestationCreateOrConnectWithoutContributionInput],
    {
      nullable: true,
    },
  )
  connectOrCreate?:
    | AttestationCreateOrConnectWithoutContributionInput[]
    | undefined;

  @TypeGraphQL.Field(
    _type => [AttestationUpsertWithWhereUniqueWithoutContributionInput],
    {
      nullable: true,
    },
  )
  upsert?:
    | AttestationUpsertWithWhereUniqueWithoutContributionInput[]
    | undefined;
  ...
  @TypeGraphQL.Field(
    _type => [AttestationUpdateWithWhereUniqueWithoutContributionInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [AttestationUpdateManyWithWhereWithoutContributionInput],
    {
      nullable: true,
    },
  )
  updateMany?:
    | AttestationUpdateManyWithWhereWithoutContributionInput[]
    | undefined;
