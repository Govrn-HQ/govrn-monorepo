...
@TypeGraphQL.InputType("GuildMembershipStatusUpdateOneRequiredWithoutGuildUsersNestedInput", {
  isAbstract: true
})
export class GuildMembershipStatusUpdateOneRequiredWithoutGuildUsersNestedInput {
