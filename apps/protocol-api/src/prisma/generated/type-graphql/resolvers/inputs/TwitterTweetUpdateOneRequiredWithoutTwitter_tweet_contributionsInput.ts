...
@TypeGraphQL.InputType("TwitterTweetUpdateOneRequiredWithoutTwitter_tweet_contributionsInput", {
  isAbstract: true
})
export class TwitterTweetUpdateOneRequiredWithoutTwitter_tweet_contributionsInput {
