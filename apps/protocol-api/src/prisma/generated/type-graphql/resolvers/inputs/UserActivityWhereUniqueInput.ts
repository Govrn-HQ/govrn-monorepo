...
export class UserActivityWhereUniqueInput {
  ...
  @TypeGraphQL.Field(_type => UserActivityUser_idActivity_type_idCompoundUniqueInput, {
    nullable: true
  })
  user_id_activity_type_id?: UserActivityUser_idActivity_type_idCompoundUniqueInput | undefined;
}
