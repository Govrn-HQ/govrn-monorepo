...
@TypeGraphQL.InputType("GuildActivityTypeUpsertWithWhereUniqueWithoutActivity_typeInput", {
  isAbstract: true
})
export class GuildActivityTypeUpsertWithWhereUniqueWithoutActivity_typeInput {
  ...
  @TypeGraphQL.Field(_type => GuildActivityTypeUpdateWithoutActivity_typeInput, {
    nullable: false
  })
