...
@TypeGraphQL.InputType('UserActivityUpdateManyWithoutActivity_typeInput', {
  isAbstract: true,
})
export class UserActivityUpdateManyWithoutActivity_typeInput {
  ...
  @TypeGraphQL.Field(
    _type => [UserActivityCreateOrConnectWithoutActivity_typeInput],
    {
      nullable: true,
    },
  )
  connectOrCreate?:
    | UserActivityCreateOrConnectWithoutActivity_typeInput[]
    | undefined;

  @TypeGraphQL.Field(
    _type => [UserActivityUpsertWithWhereUniqueWithoutActivity_typeInput],
    {
      nullable: true,
    },
  )
  upsert?:
    | UserActivityUpsertWithWhereUniqueWithoutActivity_typeInput[]
    | undefined;

  @TypeGraphQL.Field(
    _type => UserActivityCreateManyActivity_typeInputEnvelope,
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [UserActivityUpdateWithWhereUniqueWithoutActivity_typeInput],
    {
      nullable: true,
    },
  )
  update?:
    | UserActivityUpdateWithWhereUniqueWithoutActivity_typeInput[]
    | undefined;

  @TypeGraphQL.Field(
    _type => [UserActivityUpdateManyWithWhereWithoutActivity_typeInput],
    {
      nullable: true,
    },
  )
