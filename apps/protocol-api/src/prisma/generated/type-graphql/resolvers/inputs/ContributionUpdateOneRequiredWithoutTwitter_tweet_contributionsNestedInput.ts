...
@TypeGraphQL.InputType("ContributionUpdateOneRequiredWithoutTwitter_tweet_contributionsNestedInput", {
  isAbstract: true
})
export class ContributionUpdateOneRequiredWithoutTwitter_tweet_contributionsNestedInput {
