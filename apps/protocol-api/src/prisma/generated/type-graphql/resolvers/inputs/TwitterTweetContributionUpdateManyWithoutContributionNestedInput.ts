...
@TypeGraphQL.InputType("TwitterTweetContributionUpdateManyWithoutContributionNestedInput", {
  isAbstract: true
})
export class TwitterTweetContributionUpdateManyWithoutContributionNestedInput {
