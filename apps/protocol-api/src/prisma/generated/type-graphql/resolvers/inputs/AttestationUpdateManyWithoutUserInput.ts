...
export class AttestationUpdateManyWithoutUserInput {
  ...
  @TypeGraphQL.Field(
    _type => [AttestationUpsertWithWhereUniqueWithoutUserInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [AttestationUpdateWithWhereUniqueWithoutUserInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [AttestationUpdateManyWithWhereWithoutUserInput],
    {
      nullable: true,
    },
  )
