...
@TypeGraphQL.InputType('UserActivityUpdateManyWithoutUserInput', {
  isAbstract: true,
})
export class UserActivityUpdateManyWithoutUserInput {
  ...
  @TypeGraphQL.Field(
    _type => [UserActivityUpsertWithWhereUniqueWithoutUserInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [UserActivityUpdateWithWhereUniqueWithoutUserInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [UserActivityUpdateManyWithWhereWithoutUserInput],
    {
      nullable: true,
    },
  )
