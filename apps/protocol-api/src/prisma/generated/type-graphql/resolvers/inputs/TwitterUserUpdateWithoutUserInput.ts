...
@TypeGraphQL.InputType("TwitterUserUpdateWithoutUserInput", {
  isAbstract: true
})
export class TwitterUserUpdateWithoutUserInput {
  ...
  twitter_user_id?: StringFieldUpdateOperationsInput | undefined;
