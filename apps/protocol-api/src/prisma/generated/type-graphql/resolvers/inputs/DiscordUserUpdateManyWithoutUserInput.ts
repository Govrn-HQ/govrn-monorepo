...
export class DiscordUserUpdateManyWithoutUserInput {
  ...
  @TypeGraphQL.Field(
    _type => [DiscordUserUpsertWithWhereUniqueWithoutUserInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [DiscordUserUpdateWithWhereUniqueWithoutUserInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [DiscordUserUpdateManyWithWhereWithoutUserInput],
    {
      nullable: true,
    },
  )
