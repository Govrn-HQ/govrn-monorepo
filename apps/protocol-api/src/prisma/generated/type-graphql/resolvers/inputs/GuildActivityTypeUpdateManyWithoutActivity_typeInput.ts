...
export class GuildActivityTypeUpdateManyWithoutActivity_typeInput {
  ...
  @TypeGraphQL.Field(
    _type => [GuildActivityTypeUpsertWithWhereUniqueWithoutActivity_typeInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [GuildActivityTypeUpdateWithWhereUniqueWithoutActivity_typeInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [GuildActivityTypeUpdateManyWithWhereWithoutActivity_typeInput],
    {
      nullable: true,
    },
  )
  updateMany?:
    | GuildActivityTypeUpdateManyWithWhereWithoutActivity_typeInput[]
    | undefined;
