...
export class ContributionStatusUpdateOneRequiredWithoutContributionsInput {
  @TypeGraphQL.Field(
  ...
  @TypeGraphQL.Field(
    _type => ContributionStatusCreateOrConnectWithoutContributionsInput,
    {
      nullable: true,
    },
  )
  connectOrCreate?:
    | ContributionStatusCreateOrConnectWithoutContributionsInput
    | undefined;

  @TypeGraphQL.Field(
    _type => ContributionStatusUpsertWithoutContributionsInput,
    {
      nullable: true,
    },
  )
