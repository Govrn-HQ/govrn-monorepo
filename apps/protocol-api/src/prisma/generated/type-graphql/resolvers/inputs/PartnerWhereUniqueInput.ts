...
export class PartnerWhereUniqueInput {
  ...
  @TypeGraphQL.Field(_type => PartnerUser_idContribution_idCompoundUniqueInput, {
    nullable: true
  })
  user_id_contribution_id?: PartnerUser_idContribution_idCompoundUniqueInput | undefined;
}
