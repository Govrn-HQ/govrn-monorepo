...
@TypeGraphQL.InputType('LinearUserUpdateManyWithoutUserInput', {
  isAbstract: true,
})
export class LinearUserUpdateManyWithoutUserInput {
  ...
  @TypeGraphQL.Field(
    _type => [LinearUserUpsertWithWhereUniqueWithoutUserInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [LinearUserUpdateWithWhereUniqueWithoutUserInput],
    {
      nullable: true,
    },
  )
