...
export class LinearIssueUpdateManyWithoutCreatorInput {
  ...
  @TypeGraphQL.Field(
    _type => [LinearIssueUpsertWithWhereUniqueWithoutCreatorInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [LinearIssueUpdateWithWhereUniqueWithoutCreatorInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [LinearIssueUpdateManyWithWhereWithoutCreatorInput],
    {
      nullable: true,
    },
  )
