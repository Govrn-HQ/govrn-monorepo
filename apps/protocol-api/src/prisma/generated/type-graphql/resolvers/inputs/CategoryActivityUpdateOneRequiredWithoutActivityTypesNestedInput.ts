...
@TypeGraphQL.InputType("CategoryActivityUpdateOneRequiredWithoutActivityTypesNestedInput", {
  isAbstract: true
})
export class CategoryActivityUpdateOneRequiredWithoutActivityTypesNestedInput {
