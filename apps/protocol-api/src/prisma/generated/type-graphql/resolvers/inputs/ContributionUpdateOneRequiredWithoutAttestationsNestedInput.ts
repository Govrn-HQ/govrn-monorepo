...
@TypeGraphQL.InputType("ContributionUpdateOneRequiredWithoutAttestationsNestedInput", {
  isAbstract: true
})
export class ContributionUpdateOneRequiredWithoutAttestationsNestedInput {
