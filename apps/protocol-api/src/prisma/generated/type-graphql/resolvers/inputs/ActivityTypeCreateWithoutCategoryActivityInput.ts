...
@TypeGraphQL.InputType('ActivityTypeCreateWithoutCategoryActivityInput', {
  isAbstract: true,
})
export class ActivityTypeCreateWithoutCategoryActivityInput {
  ...
  @TypeGraphQL.Field(
    _type => UserActivityCreateNestedManyWithoutActivity_typeInput,
    {
      nullable: true,
    },
  )
