...
export class PartnerUpdateManyWithoutContributionInput {
  ...
  @TypeGraphQL.Field(
    _type => [PartnerUpsertWithWhereUniqueWithoutContributionInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [PartnerUpdateWithWhereUniqueWithoutContributionInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [PartnerUpdateManyWithWhereWithoutContributionInput],
    {
      nullable: true,
    },
  )
