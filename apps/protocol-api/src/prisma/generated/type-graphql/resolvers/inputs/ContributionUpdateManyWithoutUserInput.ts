...
export class ContributionUpdateManyWithoutUserInput {
  ...
  @TypeGraphQL.Field(
    _type => [ContributionUpsertWithWhereUniqueWithoutUserInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [ContributionUpdateWithWhereUniqueWithoutUserInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [ContributionUpdateManyWithWhereWithoutUserInput],
    {
      nullable: true,
    },
  )
