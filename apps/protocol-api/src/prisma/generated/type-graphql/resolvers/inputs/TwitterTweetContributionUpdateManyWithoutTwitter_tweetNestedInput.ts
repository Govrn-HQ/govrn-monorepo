...
@TypeGraphQL.InputType("TwitterTweetContributionUpdateManyWithoutTwitter_tweetNestedInput", {
  isAbstract: true
})
export class TwitterTweetContributionUpdateManyWithoutTwitter_tweetNestedInput {
