...
@TypeGraphQL.InputType("UserSplitContractOrderByWithRelationInput", {
  isAbstract: true
})
export class UserSplitContractOrderByWithRelationInput {
  ...
  split_contract?: SplitContractOrderByRelationAggregateInput | undefined;
}
