...
@TypeGraphQL.InputType('ContributionCreateWithoutLinear_issueInput', {
  isAbstract: true,
})
export class ContributionCreateWithoutLinear_issueInput {
  ...
  @TypeGraphQL.Field(
    _type => ActivityTypeCreateNestedOneWithoutContributionsInput,
    {
      nullable: false,
    },
  )
