...
@TypeGraphQL.InputType("GuildContributionUpdateManyWithWhereWithoutContributionInput", {
  isAbstract: true
})
export class GuildContributionUpdateManyWithWhereWithoutContributionInput {
