...
export class UserRelationsResolver {
  ...
  async attestations(
    @TypeGraphQL.Root() user: User,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: UserAttestationsArgs,
  ): Promise<Attestation[]> {
    return getPrismaFromContext(ctx)
      .user.findUnique({
        where: {
  ...
  async contributionPartners(
    @TypeGraphQL.Root() user: User,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: UserContributionPartnersArgs,
  ): Promise<Partner[]> {
    return getPrismaFromContext(ctx)
      .user.findUnique({
        where: {
  ...
  async contributions(
    @TypeGraphQL.Root() user: User,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: UserContributionsArgs,
  ...
  async linear_users(
    @TypeGraphQL.Root() user: User,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: UserLinear_usersArgs,
  ): Promise<LinearUser[]> {
    return getPrismaFromContext(ctx)
      .user.findUnique({
        where: {
  ...
  async guild_users(
    @TypeGraphQL.Root() user: User,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: UserGuild_usersArgs,
  ): Promise<GuildUser[]> {
    return getPrismaFromContext(ctx)
      .user.findUnique({
        where: {
  ...
  async discord_users(
    @TypeGraphQL.Root() user: User,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: UserDiscord_usersArgs,
  ): Promise<DiscordUser[]> {
    return getPrismaFromContext(ctx)
      .user.findUnique({
        where: {
