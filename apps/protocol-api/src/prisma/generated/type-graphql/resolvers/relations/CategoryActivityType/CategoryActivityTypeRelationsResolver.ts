...
export class CategoryActivityTypeRelationsResolver {
  ...
  async category_activity(@TypeGraphQL.Root() categoryActivityType: CategoryActivityType, @TypeGraphQL.Ctx() ctx: any): Promise<CategoryActivity> {
  ...
  async activity_type(@TypeGraphQL.Root() categoryActivityType: CategoryActivityType, @TypeGraphQL.Ctx() ctx: any): Promise<ActivityType> {
    return getPrismaFromContext(ctx).categoryActivityType.findUnique({
      where: {
        id: categoryActivityType.id,
      },
