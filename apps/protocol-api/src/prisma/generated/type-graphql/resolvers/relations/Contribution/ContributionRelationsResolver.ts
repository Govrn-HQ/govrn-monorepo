...
export class ContributionRelationsResolver {
  ...
  async status(
    @TypeGraphQL.Root() contribution: Contribution,
  ...
  async attestations(
    @TypeGraphQL.Root() contribution: Contribution,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: ContributionAttestationsArgs,
  ): Promise<Attestation[]> {
    return getPrismaFromContext(ctx)
      .contribution.findUnique({
        where: {
  ...
  async partners(
    @TypeGraphQL.Root() contribution: Contribution,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: ContributionPartnersArgs,
  ): Promise<Partner[]> {
    return getPrismaFromContext(ctx)
      .contribution.findUnique({
        where: {
  ...
  async guilds(
    @TypeGraphQL.Root() contribution: Contribution,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: ContributionGuildsArgs,
