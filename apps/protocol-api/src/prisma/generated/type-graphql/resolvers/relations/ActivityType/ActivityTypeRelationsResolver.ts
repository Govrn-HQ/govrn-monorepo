...
export class ActivityTypeRelationsResolver {
  ...
  async users(
    @TypeGraphQL.Root() activityType: ActivityType,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: ActivityTypeUsersArgs,
  ...
  async contributions(
    @TypeGraphQL.Root() activityType: ActivityType,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: ActivityTypeContributionsArgs,
  ...
  async categoryActivity(
    @TypeGraphQL.Root() activityType: ActivityType,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: ActivityTypeCategoryActivityArgs,
  ...
  async guilds(
    @TypeGraphQL.Root() activityType: ActivityType,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: ActivityTypeGuildsArgs,
