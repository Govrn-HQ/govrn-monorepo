...
export class AttestationConfidenceRelationsResolver {
  ...
  async attestations(@TypeGraphQL.Root() attestationConfidence: AttestationConfidence, @TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Args() args: AttestationConfidenceAttestationsArgs): Promise<Attestation[]> {
