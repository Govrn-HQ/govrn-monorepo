...
export class GuildVerificationStatusGuildArgs {
  ...
  distinct?: Array<"id" | "createdAt" | "updatedAt" | "discord_id" | "name" | "congrats_channel" | "logo" | "contribution_reporting_channel" | "status" | "verification_status_id"> | undefined;
}
