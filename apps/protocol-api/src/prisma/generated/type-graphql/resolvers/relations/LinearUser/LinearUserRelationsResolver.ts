...
export class LinearUserRelationsResolver {
  ...
  async user(
    @TypeGraphQL.Root() linearUser: LinearUser,
    @TypeGraphQL.Ctx() ctx: any,
  ): Promise<User | null> {
    return getPrismaFromContext(ctx)
      .linearUser.findUnique({
        where: {
          id: linearUser.id,
        },
      })
  ...
  async assigned_issues(
    @TypeGraphQL.Root() linearUser: LinearUser,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: LinearUserAssigned_issuesArgs,
  ): Promise<LinearIssue[]> {
    return getPrismaFromContext(ctx)
      .linearUser.findUnique({
        where: {
  ...
  async created_issues(
    @TypeGraphQL.Root() linearUser: LinearUser,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: LinearUserCreated_issuesArgs,
  ): Promise<LinearIssue[]> {
    return getPrismaFromContext(ctx)
      .linearUser.findUnique({
        where: {
