...
export class GuildActivityTypeCrudResolver {
  ...
  async createGuildActivityType(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: CreateGuildActivityTypeArgs): Promise<GuildActivityType> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async deleteGuildActivityType(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: DeleteGuildActivityTypeArgs): Promise<GuildActivityType | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async updateGuildActivityType(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpdateGuildActivityTypeArgs): Promise<GuildActivityType | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async upsertGuildActivityType(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpsertGuildActivityTypeArgs): Promise<GuildActivityType> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
