...
export class LinearProjectCrudResolver {
  ...
  async createLinearProject(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: CreateLinearProjectArgs): Promise<LinearProject> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async deleteLinearProject(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: DeleteLinearProjectArgs): Promise<LinearProject | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async upsertLinearProject(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpsertLinearProjectArgs): Promise<LinearProject> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
