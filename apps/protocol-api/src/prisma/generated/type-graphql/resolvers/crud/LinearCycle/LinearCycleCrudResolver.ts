...
export class LinearCycleCrudResolver {
  ...
  async linearCycle(
    ...
    @TypeGraphQL.Args() args: FindUniqueLinearCycleArgs,
  ...
  async createLinearCycle(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateLinearCycleArgs,
  ): Promise<LinearCycle> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async deleteLinearCycle(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteLinearCycleArgs,
  ): Promise<LinearCycle | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateLinearCycle(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateLinearCycleArgs,
  ): Promise<LinearCycle | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async upsertLinearCycle(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertLinearCycleArgs,
  ): Promise<LinearCycle> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async aggregateLinearCycle(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: AggregateLinearCycleArgs,
  ): Promise<AggregateLinearCycle> {
