...
export class GuildContributionCrudResolver {
  ...
  async createGuildContribution(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: CreateGuildContributionArgs): Promise<GuildContribution> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async deleteGuildContribution(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: DeleteGuildContributionArgs): Promise<GuildContribution | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
