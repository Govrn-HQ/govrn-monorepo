...
export class GroupByGuildArgs {
  ...
  by!: Array<"id" | "createdAt" | "updatedAt" | "discord_id" | "name" | "congrats_channel" | "logo" | "status" | "contribution_reporting_channel" | "verification_setting_id" | "twitter_integration_id">;
