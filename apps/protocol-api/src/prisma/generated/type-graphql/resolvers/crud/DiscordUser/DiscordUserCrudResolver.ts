...
export class DiscordUserCrudResolver {
  ...
  async createDiscordUser(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateDiscordUserArgs,
  ): Promise<DiscordUser> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createManyDiscordUser(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyDiscordUserArgs,
  ...
  async updateDiscordUser(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateDiscordUserArgs,
  ): Promise<DiscordUser | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async upsertDiscordUser(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertDiscordUserArgs,
  ): Promise<DiscordUser> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async aggregateDiscordUser(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: AggregateDiscordUserArgs,
  ): Promise<AggregateDiscordUser> {
  ...
  async groupByDiscordUser(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: GroupByDiscordUserArgs,
  ): Promise<DiscordUserGroupBy[]> {
