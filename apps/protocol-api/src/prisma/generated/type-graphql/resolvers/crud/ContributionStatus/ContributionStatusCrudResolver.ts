...
export class ContributionStatusCrudResolver {
  ...
  async createContributionStatus(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: CreateContributionStatusArgs): Promise<ContributionStatus> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async upsertContributionStatus(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpsertContributionStatusArgs): Promise<ContributionStatus> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
