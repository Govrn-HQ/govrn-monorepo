...
const crudResolversMap = {
  ...
  GuildVerificationStatus: crudResolvers.GuildVerificationStatusCrudResolver,
...
const actionResolversMap = {
  ...
  GuildMembershipStatus: {
    ...
    createGuildMembershipStatus: actionResolvers.CreateGuildMembershipStatusResolver,
    createManyGuildMembershipStatus: actionResolvers.CreateManyGuildMembershipStatusResolver,
    deleteGuildMembershipStatus: actionResolvers.DeleteGuildMembershipStatusResolver,
    updateGuildMembershipStatus: actionResolvers.UpdateGuildMembershipStatusResolver,
    ...
    upsertGuildMembershipStatus: actionResolvers.UpsertGuildMembershipStatusResolver,
  ...
  GuildVerificationStatus: {
    guildVerificationStatus: actionResolvers.FindUniqueGuildVerificationStatusResolver,
    findFirstGuildVerificationStatus: actionResolvers.FindFirstGuildVerificationStatusResolver,
    guildVerificationStatuses: actionResolvers.FindManyGuildVerificationStatusResolver,
    createGuildVerificationStatus: actionResolvers.CreateGuildVerificationStatusResolver,
    createManyGuildVerificationStatus: actionResolvers.CreateManyGuildVerificationStatusResolver,
    deleteGuildVerificationStatus: actionResolvers.DeleteGuildVerificationStatusResolver,
    updateGuildVerificationStatus: actionResolvers.UpdateGuildVerificationStatusResolver,
    deleteManyGuildVerificationStatus: actionResolvers.DeleteManyGuildVerificationStatusResolver,
    updateManyGuildVerificationStatus: actionResolvers.UpdateManyGuildVerificationStatusResolver,
    upsertGuildVerificationStatus: actionResolvers.UpsertGuildVerificationStatusResolver,
    aggregateGuildVerificationStatus: actionResolvers.AggregateGuildVerificationStatusResolver,
    groupByGuildVerificationStatus: actionResolvers.GroupByGuildVerificationStatusResolver
  },
  ChainType: {
  ...
  AttestationStatus: {
    ...
    createAttestationStatus: actionResolvers.CreateAttestationStatusResolver,
    createManyAttestationStatus: actionResolvers.CreateManyAttestationStatusResolver,
    deleteAttestationStatus: actionResolvers.DeleteAttestationStatusResolver,
    updateAttestationStatus: actionResolvers.UpdateAttestationStatusResolver,
    ...
    upsertAttestationStatus: actionResolvers.UpsertAttestationStatusResolver,
  ...
  TwitterTweetContribution: {
    ...
    createTwitterTweetContribution: actionResolvers.CreateTwitterTweetContributionResolver,
    createManyTwitterTweetContribution: actionResolvers.CreateManyTwitterTweetContributionResolver,
    deleteTwitterTweetContribution: actionResolvers.DeleteTwitterTweetContributionResolver,
    updateTwitterTweetContribution: actionResolvers.UpdateTwitterTweetContributionResolver,
    ...
    upsertTwitterTweetContribution: actionResolvers.UpsertTwitterTweetContributionResolver,
...
const crudResolversInfo = {
  ...
  GuildMembershipStatus: ["guildMembershipStatus", "findFirstGuildMembershipStatus", "guildMembershipStatuses", "createGuildMembershipStatus", "createManyGuildMembershipStatus", "deleteGuildMembershipStatus", "updateGuildMembershipStatus", "deleteManyGuildMembershipStatus", "updateManyGuildMembershipStatus", "upsertGuildMembershipStatus", "aggregateGuildMembershipStatus", "groupByGuildMembershipStatus"],
  ...
  GuildVerificationStatus: ["guildVerificationStatus", "findFirstGuildVerificationStatus", "guildVerificationStatuses", "createGuildVerificationStatus", "createManyGuildVerificationStatus", "deleteGuildVerificationStatus", "updateGuildVerificationStatus", "deleteManyGuildVerificationStatus", "updateManyGuildVerificationStatus", "upsertGuildVerificationStatus", "aggregateGuildVerificationStatus", "groupByGuildVerificationStatus"],
  ...
  AttestationStatus: ["attestationStatus", "findFirstAttestationStatus", "attestationStatuses", "createAttestationStatus", "createManyAttestationStatus", "deleteAttestationStatus", "updateAttestationStatus", "deleteManyAttestationStatus", "updateManyAttestationStatus", "upsertAttestationStatus", "aggregateAttestationStatus", "groupByAttestationStatus"],
  ...
  TwitterTweetContribution: ["twitterTweetContribution", "findFirstTwitterTweetContribution", "twitterTweetContributions", "createTwitterTweetContribution", "createManyTwitterTweetContribution", "deleteTwitterTweetContribution", "updateTwitterTweetContribution", "deleteManyTwitterTweetContribution", "updateManyTwitterTweetContribution", "upsertTwitterTweetContribution", "aggregateTwitterTweetContribution", "groupByTwitterTweetContribution"]
};
const argsInfo = {
  ...
  CreateGuildMembershipStatusArgs: ["data"],
  CreateManyGuildMembershipStatusArgs: ["data", "skipDuplicates"],
  DeleteGuildMembershipStatusArgs: ["where"],
  UpdateGuildMembershipStatusArgs: ["data", "where"],
  DeleteManyGuildMembershipStatusArgs: ["where"],
  UpdateManyGuildMembershipStatusArgs: ["data", "where"],
  UpsertGuildMembershipStatusArgs: ["where", "create", "update"],
  ...
  FindUniqueGuildVerificationStatusArgs: ["where"],
  FindFirstGuildVerificationStatusArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyGuildVerificationStatusArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  CreateGuildVerificationStatusArgs: ["data"],
  CreateManyGuildVerificationStatusArgs: ["data", "skipDuplicates"],
  DeleteGuildVerificationStatusArgs: ["where"],
  UpdateGuildVerificationStatusArgs: ["data", "where"],
  DeleteManyGuildVerificationStatusArgs: ["where"],
  UpdateManyGuildVerificationStatusArgs: ["data", "where"],
  UpsertGuildVerificationStatusArgs: ["where", "create", "update"],
  AggregateGuildVerificationStatusArgs: ["where", "orderBy", "cursor", "take", "skip"],
  GroupByGuildVerificationStatusArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  ...
  CreateAttestationStatusArgs: ["data"],
  CreateManyAttestationStatusArgs: ["data", "skipDuplicates"],
  DeleteAttestationStatusArgs: ["where"],
  UpdateAttestationStatusArgs: ["data", "where"],
  DeleteManyAttestationStatusArgs: ["where"],
  UpdateManyAttestationStatusArgs: ["data", "where"],
  UpsertAttestationStatusArgs: ["where", "create", "update"],
  ...
  CreateTwitterTweetContributionArgs: ["data"],
  CreateManyTwitterTweetContributionArgs: ["data", "skipDuplicates"],
  DeleteTwitterTweetContributionArgs: ["where"],
  UpdateTwitterTweetContributionArgs: ["data", "where"],
  DeleteManyTwitterTweetContributionArgs: ["where"],
  UpdateManyTwitterTweetContributionArgs: ["data", "where"],
  UpsertTwitterTweetContributionArgs: ["where", "create", "update"],
...
const relationResolversMap = {
  ...
  GuildVerificationStatus: relationResolvers.GuildVerificationStatusRelationsResolver,
...
const relationResolversInfo = {
  ...
  DiscordUser: ["user"],
  Guild: ["contributions", "users", "twitter_accounts", "activity_type", "verificationStatus"],
  GuildUser: ["user", "guild"],
  GuildContribution: ["guild", "contribution"],
  GuildActivityType: ["guild", "activity_type"],
  GuildVerificationStatus: ["Guild"],
  ChainType: ["users"],
  Chain: ["contributions"],
...
const modelsInfo = {
  ...
  Guild: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status", "verification_status_id"],
  ...
  GuildVerificationStatus: ["id", "createdAt", "updatedAt", "name"],
  ...
  LinearUser: ["id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token"],
...
const outputsInfo = {
  ...
  GuildGroupBy: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status", "verification_status_id", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  AggregateGuildVerificationStatus: ["_count", "_avg", "_sum", "_min", "_max"],
  GuildVerificationStatusGroupBy: ["id", "createdAt", "updatedAt", "name", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  LinearUserGroupBy: ["id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  GuildCount: ["contributions", "users", "twitter_accounts", "activity_type"],
  GuildCountAggregate: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status", "verification_status_id", "_all"],
  GuildAvgAggregate: ["id", "verification_status_id"],
  GuildSumAggregate: ["id", "verification_status_id"],
  GuildMinAggregate: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status", "verification_status_id"],
  GuildMaxAggregate: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status", "verification_status_id"],
  ...
  GuildVerificationStatusCount: ["Guild"],
  GuildVerificationStatusCountAggregate: ["id", "createdAt", "updatedAt", "name", "_all"],
  GuildVerificationStatusAvgAggregate: ["id"],
  GuildVerificationStatusSumAggregate: ["id"],
  GuildVerificationStatusMinAggregate: ["id", "createdAt", "updatedAt", "name"],
  GuildVerificationStatusMaxAggregate: ["id", "createdAt", "updatedAt", "name"],
  ...
  LinearUserCountAggregate: ["id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token", "_all"],
  LinearUserAvgAggregate: ["id", "user_id"],
  LinearUserSumAggregate: ["id", "user_id"],
  LinearUserMinAggregate: ["id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token"],
  LinearUserMaxAggregate: ["id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token"],
...
const inputsInfo = {
  ...
  GuildWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "status", "verification_status_id", "verificationStatus"],
  GuildOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "status", "verification_status_id", "verificationStatus"],
  GuildWhereUniqueInput: ["id", "discord_id"],
  GuildOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status", "verification_status_id", "_count", "_avg", "_max", "_min", "_sum"],
  GuildScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status", "verification_status_id"],
  GuildMembershipStatusWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name"],
  GuildMembershipStatusOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "name"],
  ...
  GuildVerificationStatusWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "Guild"],
  GuildVerificationStatusOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "name", "Guild"],
  GuildVerificationStatusWhereUniqueInput: ["id", "name"],
  GuildVerificationStatusOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "name", "_count", "_avg", "_max", "_min", "_sum"],
  GuildVerificationStatusScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name"],
  ...
  LinearUserWhereInput: ["AND", "OR", "NOT", "id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token", "user", "assigned_issues", "created_issues"],
  LinearUserOrderByWithRelationInput: ["id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token", "user", "assigned_issues", "created_issues"],
  LinearUserWhereUniqueInput: ["id", "linear_id"],
  LinearUserOrderByWithAggregationInput: ["id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token", "_count", "_avg", "_max", "_min", "_sum"],
  LinearUserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token"],
  ...
  GuildCreateInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "status", "verificationStatus"],
  GuildUpdateInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "status", "verificationStatus"],
  GuildCreateManyInput: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status", "verification_status_id"],
  GuildUpdateManyMutationInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status"],
  GuildMembershipStatusCreateInput: ["createdAt", "updatedAt", "name"],
  GuildMembershipStatusUpdateInput: ["createdAt", "updatedAt", "name"],
  ...
  GuildVerificationStatusCreateInput: ["createdAt", "updatedAt", "name", "Guild"],
  GuildVerificationStatusUpdateInput: ["createdAt", "updatedAt", "name", "Guild"],
  GuildVerificationStatusCreateManyInput: ["id", "createdAt", "updatedAt", "name"],
  GuildVerificationStatusUpdateManyMutationInput: ["createdAt", "updatedAt", "name"],
  ...
  LinearUserCreateManyInput: ["id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token"],
  ...
  GuildVerificationStatusRelationFilter: ["is", "isNot"],
  ...
  GuildCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status", "verification_status_id"],
  GuildAvgOrderByAggregateInput: ["id", "verification_status_id"],
  GuildMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status", "verification_status_id"],
  GuildMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status", "verification_status_id"],
  GuildSumOrderByAggregateInput: ["id", "verification_status_id"],
  ...
  GuildVerificationStatusCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name"],
  GuildVerificationStatusAvgOrderByAggregateInput: ["id"],
  GuildVerificationStatusMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name"],
  GuildVerificationStatusMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name"],
  GuildVerificationStatusSumOrderByAggregateInput: ["id"],
  ...
  LinearUserCountOrderByAggregateInput: ["id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token"],
  LinearUserAvgOrderByAggregateInput: ["id", "user_id"],
  LinearUserMaxOrderByAggregateInput: ["id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token"],
  LinearUserMinOrderByAggregateInput: ["id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token"],
  ...
  GuildVerificationStatusCreateNestedOneWithoutGuildInput: ["create", "connectOrCreate", "connect"],
  ...
  TwitterAccountUpdateManyWithoutGuildInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  GuildVerificationStatusUpdateOneRequiredWithoutGuildInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  GuildCreateNestedManyWithoutVerificationStatusInput: ["create", "connectOrCreate", "createMany", "connect"],
  GuildUpdateManyWithoutVerificationStatusInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  ContributionUpdateManyWithoutChainInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  TwitterTweetContributionUpdateManyWithoutContributionInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ChainUpdateOneWithoutContributionsInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  AttestationStatusUpdateOneWithoutAttestationInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  AttestationUpdateManyWithoutAttestation_statusInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  TwitterTweetContributionUpdateManyWithoutTwitter_tweetInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  GuildCreateNestedOneWithoutTwitter_accountsInput: ["create", "connectOrCreate", "connect"],
  GuildUpdateOneWithoutTwitter_accountsInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  TwitterTweetUpdateOneRequiredWithoutTwitter_tweet_contributionsInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ContributionUpdateOneRequiredWithoutTwitter_tweet_contributionsInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  LinearUserScalarWhereInput: ["AND", "OR", "NOT", "id", "active", "createdAt", "displayName", "email", "linear_id", "name", "url", "user_id", "access_token", "active_token"],
  ...
  GuildVerificationStatusCreateWithoutGuildInput: ["createdAt", "updatedAt", "name"],
  GuildVerificationStatusCreateOrConnectWithoutGuildInput: ["where", "create"],
  ...
  GuildVerificationStatusUpsertWithoutGuildInput: ["update", "create"],
  GuildVerificationStatusUpdateWithoutGuildInput: ["createdAt", "updatedAt", "name"],
  ...
  GuildCreateWithoutUsersInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "twitter_accounts", "activity_type", "contribution_reporting_channel", "status", "verificationStatus"],
  ...
  GuildUpdateWithoutUsersInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "twitter_accounts", "activity_type", "contribution_reporting_channel", "status", "verificationStatus"],
  GuildCreateWithoutContributionsInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "status", "verificationStatus"],
  ...
  GuildUpdateWithoutContributionsInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "status", "verificationStatus"],
  ...
  GuildCreateWithoutActivity_typeInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "twitter_accounts", "contribution_reporting_channel", "status", "verificationStatus"],
  ...
  GuildUpdateWithoutActivity_typeInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "twitter_accounts", "contribution_reporting_channel", "status", "verificationStatus"],
  ...
  GuildCreateWithoutVerificationStatusInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "status"],
  GuildCreateOrConnectWithoutVerificationStatusInput: ["where", "create"],
  GuildCreateManyVerificationStatusInputEnvelope: ["data", "skipDuplicates"],
  GuildUpsertWithWhereUniqueWithoutVerificationStatusInput: ["where", "update", "create"],
  GuildUpdateWithWhereUniqueWithoutVerificationStatusInput: ["where", "data"],
  GuildUpdateManyWithWhereWithoutVerificationStatusInput: ["where", "data"],
  GuildScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status", "verification_status_id"],
  ...
  GuildCreateWithoutTwitter_accountsInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "activity_type", "contribution_reporting_channel", "status", "verificationStatus"],
  GuildCreateOrConnectWithoutTwitter_accountsInput: ["where", "create"],
  GuildUpsertWithoutTwitter_accountsInput: ["update", "create"],
  GuildUpdateWithoutTwitter_accountsInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "activity_type", "contribution_reporting_channel", "status", "verificationStatus"],
  ...
  GuildCreateManyVerificationStatusInput: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contribution_reporting_channel", "status"],
  GuildUpdateWithoutVerificationStatusInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "status"],
