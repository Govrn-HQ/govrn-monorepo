...
const relationResolversInfo = {
  ...
  DiscordUser: ["user"],
  Guild: ["contributions", "users", "twitter_accounts", "activity_type", "guild_imports"],
  GuildMembershipStatus: ["guildUsers"],
  GuildUser: ["user", "guild", "membershipStatus"],
  GuildContribution: ["guild", "contribution"],
  GuildActivityType: ["guild", "activity_type"],
  IntegrationType: ["guild_imports"],
  GuildImport: ["guild", "integration_type"],
  ChainType: ["users"],
  Chain: ["contributions"],
...
const modelsInfo = {
  ...
  GuildUser: ["id", "createdAt", "updatedAt", "user_id", "guild_id", "membership_status_id", "favorite"],
  ...
  GuildImport: ["id", "createdAt", "updatedAt", "authentication_token", "guild_id", "integration_type_id"],
...
const outputsInfo = {
  ...
  DiscordUserGroupBy: ["id", "createdAt", "updatedAt", "display_name", "discord_id", "user_id", "enable_notifications", "enable_submit_reminder", "submit_reminder_period_min", "enable_mint_notification", "mint_notification_period_min", "enable_new_guild_notification", "new_guild_notification_period_min", "enable_attribution_notification", "attribution_notification_period_min", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  GuildUserGroupBy: ["id", "createdAt", "updatedAt", "user_id", "guild_id", "membership_status_id", "favorite", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  GuildImportGroupBy: ["id", "createdAt", "updatedAt", "authentication_token", "guild_id", "integration_type_id", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  DiscordUserCountAggregate: ["id", "createdAt", "updatedAt", "display_name", "discord_id", "user_id", "enable_notifications", "enable_submit_reminder", "submit_reminder_period_min", "enable_mint_notification", "mint_notification_period_min", "enable_new_guild_notification", "new_guild_notification_period_min", "enable_attribution_notification", "attribution_notification_period_min", "_all"],
  ...
  GuildUserCountAggregate: ["id", "createdAt", "updatedAt", "user_id", "guild_id", "membership_status_id", "favorite", "_all"],
  GuildUserAvgAggregate: ["id", "user_id", "guild_id", "membership_status_id"],
  GuildUserSumAggregate: ["id", "user_id", "guild_id", "membership_status_id"],
  GuildUserMinAggregate: ["id", "createdAt", "updatedAt", "user_id", "guild_id", "membership_status_id", "favorite"],
  GuildUserMaxAggregate: ["id", "createdAt", "updatedAt", "user_id", "guild_id", "membership_status_id", "favorite"],
  ...
  GuildImportCountAggregate: ["id", "createdAt", "updatedAt", "authentication_token", "guild_id", "integration_type_id", "_all"],
  GuildImportAvgAggregate: ["id", "guild_id", "integration_type_id"],
  GuildImportSumAggregate: ["id", "guild_id", "integration_type_id"],
  GuildImportMinAggregate: ["id", "createdAt", "updatedAt", "authentication_token", "guild_id", "integration_type_id"],
  GuildImportMaxAggregate: ["id", "createdAt", "updatedAt", "authentication_token", "guild_id", "integration_type_id"],
...
const inputsInfo = {
  ...
  DiscordUserWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "display_name", "discord_id", "user_id", "user", "enable_notifications", "enable_submit_reminder", "submit_reminder_period_min", "enable_mint_notification", "mint_notification_period_min", "enable_new_guild_notification", "new_guild_notification_period_min", "enable_attribution_notification", "attribution_notification_period_min"],
  DiscordUserOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "display_name", "discord_id", "user_id", "user", "enable_notifications", "enable_submit_reminder", "submit_reminder_period_min", "enable_mint_notification", "mint_notification_period_min", "enable_new_guild_notification", "new_guild_notification_period_min", "enable_attribution_notification", "attribution_notification_period_min"],
  DiscordUserWhereUniqueInput: ["id", "discord_id"],
  DiscordUserOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "display_name", "discord_id", "user_id", "enable_notifications", "enable_submit_reminder", "submit_reminder_period_min", "enable_mint_notification", "mint_notification_period_min", "enable_new_guild_notification", "new_guild_notification_period_min", "enable_attribution_notification", "attribution_notification_period_min", "_count", "_avg", "_max", "_min", "_sum"],
  DiscordUserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "display_name", "discord_id", "user_id", "enable_notifications", "enable_submit_reminder", "submit_reminder_period_min", "enable_mint_notification", "mint_notification_period_min", "enable_new_guild_notification", "new_guild_notification_period_min", "enable_attribution_notification", "attribution_notification_period_min"],
  GuildWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "contributions", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "guild_imports"],
  GuildOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "contributions", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "guild_imports"],
  ...
  GuildUserWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "user_id", "user", "guild_id", "guild", "membership_status_id", "membershipStatus", "favorite"],
  GuildUserOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "user_id", "user", "guild_id", "guild", "membership_status_id", "membershipStatus", "favorite"],
  GuildUserWhereUniqueInput: ["id", "user_id_guild_id"],
  GuildUserOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "user_id", "guild_id", "membership_status_id", "favorite", "_count", "_avg", "_max", "_min", "_sum"],
  GuildUserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "user_id", "guild_id", "membership_status_id", "favorite"],
  ...
  GuildImportWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "authentication_token", "guild_id", "guild", "integration_type_id", "integration_type"],
  GuildImportOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "authentication_token", "guild_id", "guild", "integration_type_id", "integration_type"],
  GuildImportWhereUniqueInput: ["id"],
  GuildImportOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "authentication_token", "guild_id", "integration_type_id", "_count", "_avg", "_max", "_min", "_sum"],
  GuildImportScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "authentication_token", "guild_id", "integration_type_id"],
  ...
  DiscordUserCreateInput: ["createdAt", "updatedAt", "display_name", "discord_id", "user", "enable_notifications", "enable_submit_reminder", "submit_reminder_period_min", "enable_mint_notification", "mint_notification_period_min", "enable_new_guild_notification", "new_guild_notification_period_min", "enable_attribution_notification", "attribution_notification_period_min"],
  DiscordUserUpdateInput: ["createdAt", "updatedAt", "display_name", "discord_id", "user", "enable_notifications", "enable_submit_reminder", "submit_reminder_period_min", "enable_mint_notification", "mint_notification_period_min", "enable_new_guild_notification", "new_guild_notification_period_min", "enable_attribution_notification", "attribution_notification_period_min"],
  DiscordUserCreateManyInput: ["id", "createdAt", "updatedAt", "display_name", "discord_id", "user_id", "enable_notifications", "enable_submit_reminder", "submit_reminder_period_min", "enable_mint_notification", "mint_notification_period_min", "enable_new_guild_notification", "new_guild_notification_period_min", "enable_attribution_notification", "attribution_notification_period_min"],
  DiscordUserUpdateManyMutationInput: ["createdAt", "updatedAt", "display_name", "discord_id", "enable_notifications", "enable_submit_reminder", "submit_reminder_period_min", "enable_mint_notification", "mint_notification_period_min", "enable_new_guild_notification", "new_guild_notification_period_min", "enable_attribution_notification", "attribution_notification_period_min"],
  GuildCreateInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "contributions", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "guild_imports"],
  GuildUpdateInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "contributions", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "guild_imports"],
  ...
  GuildUserCreateInput: ["createdAt", "updatedAt", "user", "guild", "membershipStatus", "favorite"],
  GuildUserUpdateInput: ["createdAt", "updatedAt", "user", "guild", "membershipStatus", "favorite"],
  GuildUserCreateManyInput: ["id", "createdAt", "updatedAt", "user_id", "guild_id", "membership_status_id", "favorite"],
  ...
  GuildImportCreateInput: ["createdAt", "updatedAt", "authentication_token", "guild", "integration_type"],
  GuildImportUpdateInput: ["createdAt", "updatedAt", "authentication_token", "guild", "integration_type"],
  GuildImportCreateManyInput: ["id", "createdAt", "updatedAt", "authentication_token", "guild_id", "integration_type_id"],
  ...
  GuildUserCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "user_id", "guild_id", "membership_status_id", "favorite"],
  GuildUserAvgOrderByAggregateInput: ["id", "user_id", "guild_id", "membership_status_id"],
  GuildUserMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "user_id", "guild_id", "membership_status_id", "favorite"],
  GuildUserMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "user_id", "guild_id", "membership_status_id", "favorite"],
  GuildUserSumOrderByAggregateInput: ["id", "user_id", "guild_id", "membership_status_id"],
  ...
  GuildImportCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "authentication_token", "guild_id", "integration_type_id"],
  GuildImportAvgOrderByAggregateInput: ["id", "guild_id", "integration_type_id"],
  GuildImportMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "authentication_token", "guild_id", "integration_type_id"],
  GuildImportMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "authentication_token", "guild_id", "integration_type_id"],
  GuildImportSumOrderByAggregateInput: ["id", "guild_id", "integration_type_id"],
  ...
  UserUpdateOneRequiredWithoutDiscord_usersNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  GuildUserCreateWithoutUserInput: ["createdAt", "updatedAt", "guild", "membershipStatus", "favorite"],
  ...
  GuildUserScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "user_id", "guild_id", "membership_status_id", "favorite"],
  ...
  GuildUserCreateWithoutGuildInput: ["createdAt", "updatedAt", "user", "membershipStatus", "favorite"],
  ...
  GuildImportCreateWithoutGuildInput: ["createdAt", "updatedAt", "authentication_token", "integration_type"],
  ...
  GuildImportScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "authentication_token", "guild_id", "integration_type_id"],
  GuildUserCreateWithoutMembershipStatusInput: ["createdAt", "updatedAt", "user", "guild", "favorite"],
  ...
  GuildCreateWithoutUsersInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "contributions", "twitter_accounts", "activity_type", "contribution_reporting_channel", "guild_imports"],
  ...
  GuildUpdateWithoutUsersInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "contributions", "twitter_accounts", "activity_type", "contribution_reporting_channel", "guild_imports"],
  ...
  GuildCreateWithoutContributionsInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "guild_imports"],
  ...
  GuildUpdateWithoutContributionsInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel", "guild_imports"],
  ...
  GuildCreateWithoutActivity_typeInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "contributions", "users", "twitter_accounts", "contribution_reporting_channel", "guild_imports"],
  ...
  GuildUpdateWithoutActivity_typeInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "contributions", "users", "twitter_accounts", "contribution_reporting_channel", "guild_imports"],
  ...
  GuildImportCreateWithoutIntegration_typeInput: ["createdAt", "updatedAt", "authentication_token", "guild"],
  ...
  GuildCreateWithoutGuild_importsInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "contributions", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel"],
  ...
  GuildUpdateWithoutGuild_importsInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "contributions", "users", "twitter_accounts", "activity_type", "contribution_reporting_channel"],
  ...
  GuildCreateWithoutTwitter_accountsInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "contributions", "users", "activity_type", "contribution_reporting_channel", "guild_imports"],
  GuildCreateOrConnectWithoutTwitter_accountsInput: ["where", "create"],
  GuildUpsertWithoutTwitter_accountsInput: ["update", "create"],
  GuildUpdateWithoutTwitter_accountsInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "status", "contributions", "users", "activity_type", "contribution_reporting_channel", "guild_imports"],
  ...
  GuildUserCreateManyUserInput: ["id", "createdAt", "updatedAt", "guild_id", "membership_status_id", "favorite"],
  ...
  GuildUserUpdateWithoutUserInput: ["createdAt", "updatedAt", "guild", "membershipStatus", "favorite"],
  ...
  GuildUserCreateManyGuildInput: ["id", "createdAt", "updatedAt", "user_id", "membership_status_id", "favorite"],
  ...
  GuildImportCreateManyGuildInput: ["id", "createdAt", "updatedAt", "authentication_token", "integration_type_id"],
  GuildContributionUpdateWithoutGuildInput: ["createdAt", "updatedAt", "contribution"],
  GuildUserUpdateWithoutGuildInput: ["createdAt", "updatedAt", "user", "membershipStatus", "favorite"],
  ...
  GuildImportUpdateWithoutGuildInput: ["createdAt", "updatedAt", "authentication_token", "integration_type"],
  GuildUserCreateManyMembershipStatusInput: ["id", "createdAt", "updatedAt", "user_id", "guild_id", "favorite"],
  GuildUserUpdateWithoutMembershipStatusInput: ["createdAt", "updatedAt", "user", "guild", "favorite"],
  GuildImportCreateManyIntegration_typeInput: ["id", "createdAt", "updatedAt", "authentication_token", "guild_id"],
  GuildImportUpdateWithoutIntegration_typeInput: ["createdAt", "updatedAt", "authentication_token", "guild"],
