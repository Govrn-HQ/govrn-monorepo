...
const relationResolversInfo = {
  ...
  DiscordUser: ["user"],
  Guild: ["contributions", "users", "twitter_account"],
  ...
  ActivityType: ["users", "contributions", "categoryActivity"],
...
const modelsInfo = {
  User: ["id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "full_name"],
  ...
  Contribution: ["id", "updatedAt", "name", "status_id", "activity_type_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id"],
  ...
  ActivityType: ["id", "createdAt", "updatedAt", "name", "active"],
...
const outputsInfo = {
  ...
  UserGroupBy: ["id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "full_name", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  ContributionGroupBy: ["id", "updatedAt", "name", "status_id", "activity_type_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  ActivityTypeGroupBy: ["id", "createdAt", "updatedAt", "name", "active", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  UserCountAggregate: ["id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "full_name", "_all"],
  UserAvgAggregate: ["id", "chain_type_id"],
  UserSumAggregate: ["id", "chain_type_id"],
  UserMinAggregate: ["id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "full_name"],
  UserMaxAggregate: ["id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "full_name"],
  DiscordUserCountAggregate: ["id", "createdAt", "updatedAt", "display_name", "discord_id", "user_id", "_all"],
  DiscordUserAvgAggregate: ["id", "discord_id", "user_id"],
  DiscordUserSumAggregate: ["id", "discord_id", "user_id"],
  ...
  GuildCount: ["contributions", "users"],
  ...
  ContributionCountAggregate: ["id", "updatedAt", "name", "status_id", "activity_type_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id", "_all"],
  ...
  ContributionMinAggregate: ["id", "updatedAt", "name", "status_id", "activity_type_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id"],
  ContributionMaxAggregate: ["id", "updatedAt", "name", "status_id", "activity_type_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id"],
  ...
  ActivityTypeCount: ["users", "contributions", "categoryActivity"],
  ActivityTypeCountAggregate: ["id", "createdAt", "updatedAt", "name", "active", "_all"],
  ActivityTypeAvgAggregate: ["id"],
  ActivityTypeSumAggregate: ["id"],
  ActivityTypeMinAggregate: ["id", "createdAt", "updatedAt", "name", "active"],
  ActivityTypeMaxAggregate: ["id", "createdAt", "updatedAt", "name", "active"],
  ...
  TwitterUserAvgAggregate: ["id", "twitter_user_id", "user_id"],
  TwitterUserSumAggregate: ["id", "twitter_user_id", "user_id"],
...
const inputsInfo = {
  UserWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "contributions", "linear_users", "guild_users", "twitter_user", "discord_users"],
  UserOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "contributions", "linear_users", "guild_users", "twitter_user", "discord_users"],
  UserWhereUniqueInput: ["id"],
  UserOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "full_name", "_count", "_avg", "_max", "_min", "_sum"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "full_name"],
  ...
  GuildWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "twitter_account"],
  GuildOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "twitter_account"],
  ...
  ContributionWhereInput: ["AND", "OR", "NOT", "id", "updatedAt", "name", "status_id", "status", "activity_type_id", "activity_type", "user_id", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "linear_issue", "tweet", "on_chain_id"],
  ContributionOrderByWithRelationInput: ["id", "updatedAt", "name", "status_id", "status", "activity_type_id", "activity_type", "user_id", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "linear_issue", "tweet", "on_chain_id"],
  ContributionWhereUniqueInput: ["id", "on_chain_id"],
  ContributionOrderByWithAggregationInput: ["id", "updatedAt", "name", "status_id", "activity_type_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id", "_count", "_avg", "_max", "_min", "_sum"],
  ContributionScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "updatedAt", "name", "status_id", "activity_type_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id"],
  ...
  ActivityTypeWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "active", "users", "contributions", "categoryActivity"],
  ActivityTypeOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "name", "active", "users", "contributions", "categoryActivity"],
  ActivityTypeWhereUniqueInput: ["id", "name"],
  ActivityTypeOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "name", "active", "_count", "_avg", "_max", "_min", "_sum"],
  ActivityTypeScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "active"],
  ...
  TwitterUserWhereUniqueInput: ["id", "twitter_user_id", "user_id"],
  ...
  UserCreateInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "contributions", "linear_users", "guild_users", "twitter_user", "discord_users"],
  UserUpdateInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "contributions", "linear_users", "guild_users", "twitter_user", "discord_users"],
  UserCreateManyInput: ["id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "full_name"],
  UserUpdateManyMutationInput: ["createdAt", "updatedAt", "name", "display_name", "address", "full_name"],
  ...
  GuildCreateInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "twitter_account"],
  GuildUpdateInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users", "twitter_account"],
  ...
  ContributionCreateInput: ["updatedAt", "name", "status", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "linear_issue", "tweet", "on_chain_id"],
  ContributionUpdateInput: ["updatedAt", "name", "status", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "linear_issue", "tweet", "on_chain_id"],
  ContributionCreateManyInput: ["id", "updatedAt", "name", "status_id", "activity_type_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id"],
  ContributionUpdateManyMutationInput: ["updatedAt", "name", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id"],
  ...
  ActivityTypeCreateInput: ["createdAt", "updatedAt", "name", "active", "users", "contributions", "categoryActivity"],
  ActivityTypeUpdateInput: ["createdAt", "updatedAt", "name", "active", "users", "contributions", "categoryActivity"],
  ActivityTypeCreateManyInput: ["id", "createdAt", "updatedAt", "name", "active"],
  ...
  UserCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "full_name"],
  UserAvgOrderByAggregateInput: ["id", "chain_type_id"],
  UserMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "full_name"],
  UserMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "full_name"],
  ...
  DiscordUserAvgOrderByAggregateInput: ["id", "discord_id", "user_id"],
  ...
  DiscordUserSumOrderByAggregateInput: ["id", "discord_id", "user_id"],
  ...
  ContributionCountOrderByAggregateInput: ["id", "updatedAt", "name", "status_id", "activity_type_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id"],
  ContributionAvgOrderByAggregateInput: ["id", "status_id", "activity_type_id", "user_id", "on_chain_id"],
  ContributionMaxOrderByAggregateInput: ["id", "updatedAt", "name", "status_id", "activity_type_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id"],
  ContributionMinOrderByAggregateInput: ["id", "updatedAt", "name", "status_id", "activity_type_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id"],
  ...
  ActivityTypeCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "active"],
  ActivityTypeAvgOrderByAggregateInput: ["id"],
  ActivityTypeMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "active"],
  ActivityTypeMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "active"],
  ...
  TwitterUserAvgOrderByAggregateInput: ["id", "twitter_user_id", "user_id"],
  ...
  TwitterUserSumOrderByAggregateInput: ["id", "twitter_user_id", "user_id"],
  ...
  ContributionCreateWithoutUserInput: ["updatedAt", "name", "status", "activity_type", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "linear_issue", "tweet", "on_chain_id"],
  ...
  ContributionScalarWhereInput: ["AND", "OR", "NOT", "id", "updatedAt", "name", "status_id", "activity_type_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id"],
  ...
  UserCreateWithoutDiscord_usersInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "contributions", "linear_users", "guild_users", "twitter_user"],
  UserCreateOrConnectWithoutDiscord_usersInput: ["where", "create"],
  UserUpsertWithoutDiscord_usersInput: ["update", "create"],
  UserUpdateWithoutDiscord_usersInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "contributions", "linear_users", "guild_users", "twitter_user"],
  ...
  UserCreateWithoutGuild_usersInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "contributions", "linear_users", "twitter_user", "discord_users"],
  UserCreateOrConnectWithoutGuild_usersInput: ["where", "create"],
  GuildCreateWithoutUsersInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "twitter_account"],
  GuildCreateOrConnectWithoutUsersInput: ["where", "create"],
  UserUpsertWithoutGuild_usersInput: ["update", "create"],
  UserUpdateWithoutGuild_usersInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "contributions", "linear_users", "twitter_user", "discord_users"],
  GuildUpsertWithoutUsersInput: ["update", "create"],
  GuildUpdateWithoutUsersInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "twitter_account"],
  GuildCreateWithoutContributionsInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "users", "twitter_account"],
  GuildCreateOrConnectWithoutContributionsInput: ["where", "create"],
  ContributionCreateWithoutGuildsInput: ["updatedAt", "name", "status", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "linear_issue", "tweet", "on_chain_id"],
  ContributionCreateOrConnectWithoutGuildsInput: ["where", "create"],
  GuildUpsertWithoutContributionsInput: ["update", "create"],
  GuildUpdateWithoutContributionsInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "users", "twitter_account"],
  ContributionUpsertWithoutGuildsInput: ["update", "create"],
  ContributionUpdateWithoutGuildsInput: ["updatedAt", "name", "status", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "linear_issue", "tweet", "on_chain_id"],
  UserCreateWithoutChain_typeInput: ["createdAt", "updatedAt", "name", "display_name", "address", "full_name", "activities", "attestations", "contributionPartners", "contributions", "linear_users", "guild_users", "twitter_user", "discord_users"],
  ...
  UserScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "display_name", "address", "chain_type_id", "full_name"],
  ...
  ActivityTypeCreateWithoutContributionsInput: ["createdAt", "updatedAt", "name", "active", "users", "categoryActivity"],
  ActivityTypeCreateOrConnectWithoutContributionsInput: ["where", "create"],
  UserCreateWithoutContributionsInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "linear_users", "guild_users", "twitter_user", "discord_users"],
  ...
  ActivityTypeUpdateWithoutContributionsInput: ["createdAt", "updatedAt", "name", "active", "users", "categoryActivity"],
  UserUpsertWithoutContributionsInput: ["update", "create"],
  UserUpdateWithoutContributionsInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "linear_users", "guild_users", "twitter_user", "discord_users"],
  ...
  UserCreateWithoutContributionPartnersInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributions", "linear_users", "guild_users", "twitter_user", "discord_users"],
  UserCreateOrConnectWithoutContributionPartnersInput: ["where", "create"],
  ContributionCreateWithoutPartnersInput: ["updatedAt", "name", "status", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "guilds", "linear_issue", "tweet", "on_chain_id"],
  ContributionCreateOrConnectWithoutPartnersInput: ["where", "create"],
  UserUpsertWithoutContributionPartnersInput: ["update", "create"],
  UserUpdateWithoutContributionPartnersInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributions", "linear_users", "guild_users", "twitter_user", "discord_users"],
  ContributionUpsertWithoutPartnersInput: ["update", "create"],
  ContributionUpdateWithoutPartnersInput: ["updatedAt", "name", "status", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "guilds", "linear_issue", "tweet", "on_chain_id"],
  ...
  UserCreateWithoutAttestationsInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "contributionPartners", "contributions", "linear_users", "guild_users", "twitter_user", "discord_users"],
  UserCreateOrConnectWithoutAttestationsInput: ["where", "create"],
  ContributionCreateWithoutAttestationsInput: ["updatedAt", "name", "status", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "partners", "guilds", "linear_issue", "tweet", "on_chain_id"],
  ...
  UserUpdateWithoutAttestationsInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "contributionPartners", "contributions", "linear_users", "guild_users", "twitter_user", "discord_users"],
  ContributionUpsertWithoutAttestationsInput: ["update", "create"],
  ContributionUpdateWithoutAttestationsInput: ["updatedAt", "name", "status", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "partners", "guilds", "linear_issue", "tweet", "on_chain_id"],
  ...
  ContributionCreateWithoutStatusInput: ["updatedAt", "name", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "linear_issue", "tweet", "on_chain_id"],
  ...
  ContributionCreateWithoutActivity_typeInput: ["updatedAt", "name", "status", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "linear_issue", "tweet", "on_chain_id"],
  ...
  UserCreateWithoutActivitiesInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "attestations", "contributionPartners", "contributions", "linear_users", "guild_users", "twitter_user", "discord_users"],
  UserCreateOrConnectWithoutActivitiesInput: ["where", "create"],
  ActivityTypeCreateWithoutUsersInput: ["createdAt", "updatedAt", "name", "active", "contributions", "categoryActivity"],
  ActivityTypeCreateOrConnectWithoutUsersInput: ["where", "create"],
  UserUpsertWithoutActivitiesInput: ["update", "create"],
  UserUpdateWithoutActivitiesInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "attestations", "contributionPartners", "contributions", "linear_users", "guild_users", "twitter_user", "discord_users"],
  ActivityTypeUpsertWithoutUsersInput: ["update", "create"],
  ActivityTypeUpdateWithoutUsersInput: ["createdAt", "updatedAt", "name", "active", "contributions", "categoryActivity"],
  ...
  ActivityTypeCreateWithoutCategoryActivityInput: ["createdAt", "updatedAt", "name", "active", "users", "contributions"],
  ...
  ActivityTypeUpdateWithoutCategoryActivityInput: ["createdAt", "updatedAt", "name", "active", "users", "contributions"],
  ...
  ContributionCreateWithoutLinear_issueInput: ["updatedAt", "name", "status", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "tweet", "on_chain_id"],
  ...
  ContributionUpdateWithoutLinear_issueInput: ["updatedAt", "name", "status", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "tweet", "on_chain_id"],
  UserCreateWithoutLinear_usersInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "contributions", "guild_users", "twitter_user", "discord_users"],
  ...
  UserUpdateWithoutLinear_usersInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "contributions", "guild_users", "twitter_user", "discord_users"],
  ...
  UserCreateWithoutTwitter_userInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "contributions", "linear_users", "guild_users", "discord_users"],
  ...
  UserUpdateWithoutTwitter_userInput: ["createdAt", "updatedAt", "name", "display_name", "address", "chain_type", "full_name", "activities", "attestations", "contributionPartners", "contributions", "linear_users", "guild_users", "discord_users"],
  ...
  ContributionCreateWithoutTweetInput: ["updatedAt", "name", "status", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "linear_issue", "on_chain_id"],
  ...
  ContributionUpdateWithoutTweetInput: ["updatedAt", "name", "status", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "linear_issue", "on_chain_id"],
  GuildCreateWithoutTwitter_accountInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users"],
  GuildCreateOrConnectWithoutTwitter_accountInput: ["where", "create"],
  GuildUpsertWithoutTwitter_accountInput: ["update", "create"],
  GuildUpdateWithoutTwitter_accountInput: ["createdAt", "updatedAt", "discord_id", "name", "congrats_channel", "logo", "contributions", "users"],
  ...
  ContributionCreateManyUserInput: ["id", "updatedAt", "name", "status_id", "activity_type_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id"],
  ...
  ContributionUpdateWithoutUserInput: ["updatedAt", "name", "status", "activity_type", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "linear_issue", "tweet", "on_chain_id"],
  ...
  UserCreateManyChain_typeInput: ["id", "createdAt", "updatedAt", "name", "display_name", "address", "full_name"],
  UserUpdateWithoutChain_typeInput: ["createdAt", "updatedAt", "name", "display_name", "address", "full_name", "activities", "attestations", "contributionPartners", "contributions", "linear_users", "guild_users", "twitter_user", "discord_users"],
  ...
  ContributionCreateManyStatusInput: ["id", "updatedAt", "name", "activity_type_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id"],
  ContributionUpdateWithoutStatusInput: ["updatedAt", "name", "activity_type", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "linear_issue", "tweet", "on_chain_id"],
  UserActivityCreateManyActivity_typeInput: ["id", "createdAt", "updatedAt", "user_id"],
  ContributionCreateManyActivity_typeInput: ["id", "updatedAt", "name", "status_id", "user_id", "date_of_submission", "date_of_engagement", "details", "proof", "default", "on_chain_id"],
  ...
  ContributionUpdateWithoutActivity_typeInput: ["updatedAt", "name", "status", "user", "date_of_submission", "date_of_engagement", "details", "proof", "default", "attestations", "partners", "guilds", "linear_issue", "tweet", "on_chain_id"],
